...
$M_X(t) = \sum_{r = 0}^{\infty} \frac{E(X^r)}{r!} t^r = 1 + \sum_{r = 1}^{\infty} \frac{E(X^r)}{r!} t^r = 1 + \sum_{r = 1}^{\infty} \frac{0.8}{r!} t^r = 0.2 + 0.8[1 + \sum_{r = 1}^{\infty} \frac{1}{r!} = 0.2 + 0.8 \sum_{r = 0}^{\infty} \frac{1}{r!}$
